...
const colleges: College[] = [
  {
    ...
    courses: [
      ...
      {
        name: 'MA Applied and Forensic Linguistics',
        description: ' Canterbury, 1 Years, 10/9/2024, 15500 GBP',
        features: [
      ...
      {
        name: 'MA Applied and Forensic Linguistics with Extended Masters',
        description: ' Canterbury, 1 Years, 10/9/2024, 15500 GBP',
        features: [
          'IELTS:	6 or Equivalent',
      ...
      {
        name: 'MA Applied Linguistics with Extended Masters',
        description: ' Canterbury, 1 Years, 10/9/2024, 15500 GBP',
        features: [
          'IELTS:	6 or Equivalent',
      ...
      {
        name: 'MA Arts, Health and Performance',
        description: ' Canterbury, 1 Years, 10/9/2024, 15500 GBP',
        features: [
          'IELTS:	6 or Equivalent',
      ...
      {
        name: 'MA Chaplaincy and Spiritual Care',
        description: ' Canterbury, 1 Years, 10/9/2024, 15500 GBP',
        features: [
          'IELTS:	6 or Equivalent',
      ...
      {
        name: 'MA Creative and Cultural Industries',
        description: ' Canterbury, 1 Years, 10/9/2024, 15500 GBP',
        features: [
          'IELTS:	6 or Equivalent',
      ...
      {
        name: 'MA Early Childhood Education',
        description: ' Canterbury, 1 Years, 10/9/2024, 15500 GBP',
        features: [
          'IELTS:	6 or Equivalent',
      ...
      {
        name: 'MA Early Childhood Education with Extended Masters',
        description: ' Canterbury, 1 Years, 10/9/2024, 15500 GBP',
        features: [
          'IELTS:	6 or Equivalent',
      ...
      {
        name: 'BA Archaeology',
        description: ' Canterbury, 3 Years, 10/9/2024, 46500 GBP',
        features: [
          'IELTS:	6 or Equivalent',
...

  {
    ...
    courses: [
      ...
      {
        name: 'MA Art Writing',
        description: ' Farnham, 1 or 2 Years, 10/9/2024, 18000 GBP',
        features: [
          'IELTS:	6 or Equivalent',
